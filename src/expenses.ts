...
program
  ...
  .action(async function (opts: CommandOptions): Promise<void> {
    ...
    for (const file of files) {
      ...
      const [, year, month, day, provider, description, amount, currency] = matches as [string, ...ExpenseMatch[keyof ExpenseMatch][]]
